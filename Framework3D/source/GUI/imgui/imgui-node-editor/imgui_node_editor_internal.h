...
# undef DECLARE_HAS_MEMBER
            ...
            struct FringeScaleRef
            {
                ...
                template<typename T>
                static float& Get(
                    typename std::enable_if<HasFringeScale<T>::value, T>::type*
                    drawList)
                {
            ...
            struct FringeScaleScope
            {
                FringeScaleScope(float scale)
                    : m_LastFringeScale(
                        ImFringeScaleRef(ImGui::GetWindowDrawList()))
                {
            ...
            {
                using Super = detail::SafePointerType<ObjectId>;
                using Super::Super;

                ObjectId()
                    : Super(Invalid), m_Type(ObjectType::None)
                {
                }

                ObjectId(SocketID pinId)
                ...
                explicit operator SocketID() const
                {
                    return AsPinId();
                }

                explicit operator NodeId() const
                {
                    return AsNodeId();
                }

                explicit operator LinkId() const
                {
                    return AsLinkId();
                }

                SocketID AsPinId() const
                {
                    IM_ASSERT(IsPinId());
                    return SocketID(AsPointer());
                }
            ...
            struct Object
            {
                ...
                inline friend DrawFlags& operator|=(
                    DrawFlags& lhs,
                    DrawFlags rhs)
                {
                    lhs = lhs | rhs;
                ...
                virtual bool EndDrag()
                {
                    return false;
                }

                virtual ImVec2 DragStartLocation()
                {
                ...
                virtual bool TestHit(
                    const ImVec2& point,
                    float extraThickness = 0.0f) const
                {
                    if (!m_IsLive)
                        return false;
                ...
                virtual bool TestHit(
                    const ImRect& rect,
                    bool allowIntersect = true) const
                {
                    if (!m_IsLive)
                        return false;
                    ...
                    return !ImRect_IsEmpty(bounds) && (allowIntersect
            ...
            struct Pin final : Object
            {
                ...
                Pin(EditorContext* editor, SocketID id, PinKind kind)
                    : Object(editor)
                      , m_ID(id)
                      , m_Kind(kind)
                      , m_Node(nullptr)
                ...
                void Draw(ImDrawList* drawList, DrawFlags flags = None) final;

                ImVec2 GetClosestPoint(const ImVec2& p) const;
                ImLine GetClosestLine(const Pin* pin) const;

                ImRect GetBounds() const final
                {
                    return m_Bounds;
                }
            ...
            struct Node final : Object
            {
                ...
                ImVec2 DragStartLocation() override
                {
                    return m_DragStart;
                }
                ...
                void GetGroupedNodes(
                    std::vector<Node*>& result,
                    bool append = false);

                void CenterOnScreenInNextFrame()
                {
            ...
            struct Link final : Object
            {
                ...
                bool TestHit(
                    const ImVec2& point,
                    float extraThickness = 0.0f) const final;
                bool TestHit(
                    const ImRect& rect,
                    bool allowIntersect = true) const final;
            ...
            private:
                void OnUpdate(float progress) final;
                void OnStop() final;
                void OnFinish() final;
            };
            ...
            struct FlowAnimationController final : AnimationController
            {
                ...
                void Draw(ImDrawList* drawList) final;
            ...
            struct EditorAction
            {
                ...
                virtual void Reject()
                {
                } // celled when Accept return 'Possible' and was rejected

                virtual ImGuiMouseCursor GetCursor()
                {
                ...
                virtual NavigateAction* AsNavigate()
                {
                    return nullptr;
                }

                virtual SizeAction* AsSize()
                {
                    return nullptr;
                }

                virtual DragAction* AsDrag()
                {
                    return nullptr;
                }

                virtual SelectAction* AsSelect()
                {
                    return nullptr;
                }

                virtual CreateItemAction* AsCreateItem()
                {
                    return nullptr;
                }

                virtual DeleteItemsAction* AsDeleteItems()
                {
                    return nullptr;
                }

                virtual ContextMenuAction* AsContextMenu()
                {
                    return nullptr;
                }

                virtual ShortcutAction* AsCutCopyPaste()
                {
                    return nullptr;
                }
            ...
            struct NavigateAction final : EditorAction
            {
                ...
                AcceptResult Accept(const Control& control) final;
                bool Process(const Control& control) final;

                void ShowMetrics() final;

                NavigateAction* AsNavigate() final
                {
                    return this;
                }
                ...
                bool IsMovingOverEdge() const
                {
                    return m_MovingOverEdge;
                }

                ImVec2 GetMoveScreenOffset() const
                {
                ...
                ImVec2 GetWindowScreenPos() const
                {
                    return m_WindowScreenPos;
                };

                ImVec2 GetWindowScreenSize() const
                {
            ...
            struct SizeAction final : EditorAction
            {
                ...
                ImGuiMouseCursor GetCursor() final
                {
                    return m_Cursor;
                }
                ...
                SizeAction* AsSize() final
                {
                    return this;
                }

                bool IsDragging() final
                {
                    return m_IsActive;
                }

                const ImRect& GetStartGroupBounds() const
                {
            ...
            struct ContextMenuAction final : EditorAction
            {
                ...
                ContextMenuAction* AsContextMenu() final
                {
                    return this;
                }

                bool ShowNodeContextMenu(NodeId* nodeId);
                bool ShowPinContextMenu(SocketID* pinId);
            ...
            struct ShortcutAction final : EditorAction
            {
                ...
                ShortcutAction* AsCutCopyPaste() final
                {
                    return this;
                }
            ...
            struct CreateItemAction final : EditorAction
            {
                ...
                CreateItemAction* AsCreateItem() final
                {
                    return this;
                }
                ...
                Result QueryLink(SocketID* startId, SocketID* endId);
                Result QueryNode(SocketID* pinId);
            ...
            struct DeleteItemsAction final : EditorAction
            {
                ...
                DeleteItemsAction* AsDeleteItems() final
                {
                    return this;
                }
                ...
                bool QueryLink(
                    LinkId* linkId,
                    SocketID* startId = nullptr,
                    SocketID* endId = nullptr);
            ...
            struct NodeBuilder
            {
                ...
                void BeginPin(SocketID pinId, PinKind kind);
                void EndPin();
            ...
            {
                return static_cast<SuspendFlags>(
                    static_cast<uint8_t>(lhs) | static_cast<uint8_t>(rhs));
            }
            ...
            struct EditorContext
            {
                ...
                HintBuilder& GetHintBuilder()
                {
                    return m_HintBuilder;
                }

                EditorAction* GetCurrentAction()
                {
                    return m_CurrentAction;
                }

                CreateItemAction& GetItemCreator()
                {
                    return m_CreateItemAction;
                }

                DeleteItemsAction& GetItemDeleter()
                {
                ...
                ShortcutAction& GetShortcut()
                {
                    return m_ShortcutAction;
                }

                const ImGuiEx::CanvasView& GetView() const
                {
                    return m_Canvas.View();
                }

                const ImRect& GetViewRect() const
                {
                ...
                void FindNodesInRect(
                    const ImRect& r,
                    vector<Node*>& result,
                    bool append = false,
                    bool includeIntersecting = true);
                void FindLinksInRect(
                    const ImRect& r,
                    vector<Link*>& result,
                    bool append = false);

                bool HasAnyLinks(NodeId nodeId) const;
                bool HasAnyLinks(SocketID pinId) const;

                int BreakLinks(NodeId nodeId);
                int BreakLinks(SocketID pinId);

                void FindLinksForNode(
                    NodeId nodeId,
                    vector<Link*>& result,
                    bool add = false);

                bool PinHadAnyLinks(SocketID pinId);

                ImVec2 ToCanvas(const ImVec2& point) const
                {
                ...
                SocketID GetHoveredPin() const
                {
                    return m_HoveredPin;
                }

                LinkId GetHoveredLink() const
                {
                    return m_HoveredLink;
                }

                NodeId GetDoubleClickedNode() const
                {
                    return m_DoubleClickedNode;
                }

                SocketID GetDoubleClickedPin() const
                {
                    return m_DoubleClickedPin;
                }

                LinkId GetDoubleClickedLink() const
                {
                    return m_DoubleClickedLink;
                }

                bool IsBackgroundClicked() const
                {
                    return m_BackgroundClickButtonIndex >= 0;
                }

                bool IsBackgroundDoubleClicked() const
                {
                    return m_BackgroundDoubleClickButtonIndex >= 0;
                }

                ImGuiMouseButton GetBackgroundClickButtonIndex() const
                {
            ...
            private:
                ...
                SocketID m_HoveredPin;
                LinkId m_HoveredLink;
                NodeId m_DoubleClickedNode;
                SocketID m_DoubleClickedPin;
