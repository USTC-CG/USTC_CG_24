...
namespace USTC_CG::node_pcss_shadow_masking {
static void node_declare(NodeDeclarationBuilder& b)
{
    b.add_input<decl::Texture>("Shadow Masks");
    b.add_input<decl::Texture>("Color");
    b.add_input<decl::Texture>("Position");
    b.add_input<decl::String>("Shader").default_val("shaders/shadow_masking_pcss.fs");
...
static void node_register()
{
    ...
    strcpy(ntype.ui_name, "PCSS Shadow Masking");
    strcpy_s(ntype.id_name, "render_pcss_shadow_masking");
