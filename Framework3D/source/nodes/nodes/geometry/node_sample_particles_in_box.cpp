...
namespace USTC_CG::node_sample_particle_in_box {
...
static void node_exec(ExeParams params)
{
    ...
    auto particle_pos = ParticleSystem::sample_particle_pos_in_a_box(
...
static void node_register()
{
    ...
    strcpy(ntype.ui_name, "Sample Particles In a box");
    strcpy_s(ntype.id_name, "geom_sample_particle_in_a_box");
...
}  // namespace USTC_CG::node_sample_particles_in_a_box
