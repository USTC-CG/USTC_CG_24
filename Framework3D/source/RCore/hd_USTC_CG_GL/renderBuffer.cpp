...
Hd_USTC_CG_GL_RenderBuffer::Hd_USTC_CG_GL_RenderBuffer(SdfPath const &id)
    : HdRenderBuffer(id),
      _width(0),
      _height(0),
...
Hd_USTC_CG_GL_RenderBuffer::~Hd_USTC_CG_GL_RenderBuffer() = default;

/*virtual*/
void Hd_USTC_CG_GL_RenderBuffer::Sync(
...
/*virtual*/
void Hd_USTC_CG_GL_RenderBuffer::_Deallocate()
{
...
/*static*/
size_t Hd_USTC_CG_GL_RenderBuffer::_GetBufferSize(GfVec2i const &dims, HdFormat format)
{
    return dims[0] * dims[1] * HdDataSizeOfFormat(format);
}

/*static*/
HdFormat Hd_USTC_CG_GL_RenderBuffer::_GetSampleFormat(HdFormat format)
{
...
/*virtual*/
void Hd_USTC_CG_GL_RenderBuffer::Resolve()
{
