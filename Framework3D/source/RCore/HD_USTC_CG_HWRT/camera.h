...
using namespace pxr;
class Hd_USTC_CG_HWRT_Camera : public HdCamera
{
public:
    explicit Hd_USTC_CG_HWRT_Camera(const SdfPath& id)
        : HdCamera(id)
    {
    }
    ...
    void attachFilm(Hd_USTC_CG_HWRT_RenderBuffer* new_film) const;

    mutable Hd_USTC_CG_HWRT_RenderBuffer* film;
