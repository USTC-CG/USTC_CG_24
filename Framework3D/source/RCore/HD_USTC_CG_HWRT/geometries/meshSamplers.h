...
using namespace pxr;
/// \class Hd_USTC_CG_HWRT_RTCBufferAllocator
///
...
// ----------------------------------------------------------------------
// The classes below implement the Hd_USTC_CG_HWRT_PrimvarSampler interface for
...
/// \class Hd_USTC_CG_HWRT_ConstantSampler
///
/// This class implements the Hd_USTC_CG_HWRT_PrimvarSampler interface for primvars
...
class Hd_USTC_CG_HWRT_ConstantSampler : public Hd_USTC_CG_HWRT_PrimvarSampler
{
public:
    /// Constructor.
...
private:
    ...
    const Hd_USTC_CG_HWRT_BufferSampler _sampler;
};

/// \class Hd_USTC_CG_HWRT_UniformSampler
///
/// This class implements the Hd_USTC_CG_HWRT_PrimvarSampler interface for primvars
/// with "uniform" interpolation mode. This means that the buffer has one
/// item per authored face. For unrefined meshes, Hd_USTC_CG_HWRT_ will convert
...
class Hd_USTC_CG_HWRT_UniformSampler : public Hd_USTC_CG_HWRT_PrimvarSampler
{
public:
    /// Constructor.
    /// \param name The name of the primvar.
...
/// \class Hd_USTC_CG_HWRT_TriangleVertexSampler
///
/// This class implements the Hd_USTC_CG_HWRT_PrimvarSampler interface for primvars on
...
class Hd_USTC_CG_HWRT_TriangleVertexSampler : public Hd_USTC_CG_HWRT_PrimvarSampler
{
public:
    /// Constructor.
    /// \param name The name of the primvar.
...
/// \class Hd_USTC_CG_HWRT_TriangleFaceVaryingSampler
///
/// This class implements the Hd_USTC_CG_HWRT_PrimvarSampler interface for primvars on
...
class Hd_USTC_CG_HWRT_TriangleFaceVaryingSampler : public Hd_USTC_CG_HWRT_PrimvarSampler
{
public:
...
/// \class Hd_USTC_CG_HWRT_SubdivVertexSampler
///
/// This class implements the Hd_USTC_CG_HWRT_PrimvarSampler interface for primvars on
...
class Hd_USTC_CG_HWRT_SubdivVertexSampler : public Hd_USTC_CG_HWRT_PrimvarSampler
{
public:
    ...
    ~Hd_USTC_CG_HWRT_SubdivVertexSampler() override;
...
private:
    ...
    RTCScene _meshScene;
    unsigned _meshId;
    Hd_USTC_CG_HWRT_RTCBufferAllocator* _allocator;
};
