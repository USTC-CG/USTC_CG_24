...
using namespace pxr;
Hd_USTC_CG_Instancer::Hd_USTC_CG_Instancer(HdSceneDelegate* delegate, const SdfPath& id)
...
VtMatrix4dArray Hd_USTC_CG_Instancer::ComputeInstanceTransforms(const SdfPath& prototypeId)
{
    HD_TRACE_FUNCTION();
    HF_MALLOC_TAG_FUNCTION();
    ...
    VtMatrix4dArray parentTransforms =
        static_cast<Hd_USTC_CG_Instancer*>(parentInstancer)->ComputeInstanceTransforms(GetId());
